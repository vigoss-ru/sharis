...
class SystemWidgetkitHelper extends WidgetkitHelper {
	...
	*/
	public function init() {
        ...
        $this['path']->register(get_template_directory(), 'theme');

        // if the theme has a widgets-folder, than register it
        if ($path = $this['path']->path('theme:widgetkit')) {
        	$this['path']->register($path, 'widgets');
        }
