...
$block_classes = array();
foreach ($blocks as $block) { $block_classes[$block] = $config->get("block.{$block}.block-bg"); }
...
$this['asset']->addFile('css', 'css:timeline-style.css');
$this['asset']->addFile('css', 'css:timeline-reset.css');
...
$this['asset']->addFile('js', 'js:timeline-main.js');
$this['asset']->addFile('js', 'js:timeline-modernizr.js');
